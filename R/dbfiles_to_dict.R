...
#' @param dataid_uri string containing the URI used in the POST request that publishes the DataID documentation, as created by \code{\link{getTargetURIDataID}}
